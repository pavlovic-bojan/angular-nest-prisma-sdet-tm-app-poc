...
@Component({
  ...
  template: `
    <div class="flex justify-between items-center mb-4 md:mb-6 gap-2 flex-wrap">
      <h2 class="text-xl md:text-2xl font-bold text-slate-800 dark:text-white" data-testid="page-heading">Projects</h2>
      <button
    ...
    <div class="bg-white dark:bg-slate-900 rounded-xl shadow overflow-hidden border border-slate-200 dark:border-slate-700">
      ...
      <table class="w-full min-w-max" data-testid="projects-table">
        ...
        <tbody>
          @for (project of paginatedProjects(); track project.id) {
            <tr class="border-t border-slate-200 dark:border-slate-700 hover:bg-slate-50 dark:hover:bg-slate-800/50" [attr.data-testid]="'project-row-' + project.id">
              ...
              <td class="px-4 py-3 text-right">
                <div class="flex justify-end gap-2">
                  <button
                    ...
                    [attr.data-testid]="'project-edit-' + project.id"
                  ...
                  <button
                    ...
                    [attr.data-testid]="'project-delete-' + project.id"
            ...
            <tr>
              <td colspan="4" class="px-4 py-8 text-center text-slate-500" data-testid="projects-empty">No projects yet</td>
            </tr>
          }
        </tbody>
      </table>
...
export class ProjectListComponent {
  ...
  async load(): Promise<void> {
    const p = await this.projectService.getAll();
    this.projects.set(p);
  }
